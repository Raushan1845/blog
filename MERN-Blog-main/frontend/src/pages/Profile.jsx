      ...
      <Card className=" flex md:flex-row flex-col gap-10 p-6 md:p-10 dark:bg-gray-800 mx-4 md:mx-0">
        <div className='flex flex-col items-center justify-center md:w-[400px]'>
          ...
          <div className='flex gap-4 items-center'>
            ...
            <Link ><FaLinkedin className='w-6 h-6 dark:text-gray-300 text-gray-800' /></Link>
            <Link ><FaGithub className='w-6 h-6 dark:text-gray-300 text-gray-800' /></Link>
                  ...
                  <div className="grid gap-4 py-4">
                    <div className='flex gap-2'>
                      <div className="grid gap-3">
                        ...
                        <Input id="firstname" name="firstname" value={input.firstName}
                          onChange={changeEventHandler} placeholder="First Name" type="text" className="col-span-3 text-gray-500" />
                      </div>
                      <div className="grid gap-3">
                        <Label htmlFor="username-1" className="text-right mb-1">Last Name</Label>
                        <Input id="lastname" name="lastname" value={input.lastName}
                          onChange={changeEventHandler} placeholder="Last Name" type="text" className="col-span-3 text-gray-500" />
                      </div>
                    </div>
                    <div className='flex gap-2'>
                      <div className="grid gap-3">
                        <Label htmlFor="name-1" className="text-right mb-1">Facebook</Label>
                        <Input id="facebook" name="facebook" value={input.facebook}
                          onChange={changeEventHandler} placeholder="Enter a URL" type="text" className="col-span-3 text-gray-500" />
                      </div>
                      <div className="grid gap-3">
                    ...
                    <div className='flex gap-2'>
                      ...
                      <div className="grid gap-3">
                        <Label htmlFor="username-1" className="text-right mb-1">Github</Label>
                        <Input id="github" name="github" value={input.github}
                          onChange={changeEventHandler} placeholder="Enter a URL" type="text" className="col-span-3 text-gray-500" />
                      </div>
                    </div>
                    <div>
            ...
            <div className='max-w-6xl mx-auto mt-8 '>
                <Card className=" flex md:flex-row flex-col gap-10 p-6 md:p-10 dark:bg-gray-800 mx-4 md:mx-0">
                    ...
                    <div className='flex flex-col items-center justify-center md:w-[400px]'>
                        ...
                        <h1 className='text-center font-semibold text-xl text-gray-700 dark:text-gray-300 my-3'>{user?.occupation ||"User"}</h1>
                        <div className='flex gap-4 items-center'>
                            <Link ><FaFacebook className='w-6 h-6 text-gray-800 dark:text-gray-300' /></Link>
